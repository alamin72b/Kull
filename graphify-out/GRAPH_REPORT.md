...
## Corpus Check
- 66 files · ~17,336 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 517 nodes · 665 edges · 33 communities (25 shown, 8 thin omitted)
...
1. `DebugNotesService` - 22 edges
2. `compilerOptions` - 22 edges
3. `Activity` - 22 edges
4. `ActivitiesService` - 18 edges
5. `compilerOptions` - 16 edges
6. `scripts` - 12 edges
7. `CreateDebugNoteDto` - 12 edges
8. `QueryDebugNotesDto` - 12 edges
...
Cohesion: 0.10
Nodes (22): ActivitiesController, Controller, ActivitiesService, Injectable, CreateActivityDto, IsOptional, IsString, Matches (+14 more)
...
Cohesion: 0.10
Nodes (13): ActivitiesModule, Module, AppModule, Module, PrismaModule, Module, PrismaService, Injectable (+5 more)
...
- **Why does `Activity` connect `Activity` to `activity-dashboard.tsx`?**
